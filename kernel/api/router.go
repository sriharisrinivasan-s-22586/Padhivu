...
func ServeAPI(ginServer *gin.Engine) {
	...
	ginServer.Handle("POST", "/api/sync/setSyncProviderLAN", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, setSyncProviderLAN)
	...
	ginServer.Handle("GET", "/api/sync/lan/ping", lanPing)
	ginServer.Handle("POST", "/api/sync/lan/createRepo", lanCreateRepo)
	ginServer.Handle("POST", "/api/sync/lan/removeRepo", lanRemoveRepo)
	ginServer.Handle("POST", "/api/sync/lan/getRepos", lanGetRepos)
	ginServer.Handle("POST", "/api/sync/lan/uploadBytes", lanUploadBytes)
	ginServer.Handle("POST", "/api/sync/lan/downloadObject", lanDownloadObject)
	ginServer.Handle("POST", "/api/sync/lan/removeObject", lanRemoveObject)
	ginServer.Handle("POST", "/api/sync/lan/getTags", lanGetTags)
	ginServer.Handle("POST", "/api/sync/lan/getIndexes", lanGetIndexes)
	ginServer.Handle("POST", "/api/sync/lan/getRefsFiles", lanGetRefsFiles)
	ginServer.Handle("POST", "/api/sync/lan/getChunks", lanGetChunks)
	ginServer.Handle("POST", "/api/sync/lan/getStat", lanGetStat)
	ginServer.Handle("POST", "/api/sync/lan/listObjects", lanListObjects)
	ginServer.Handle("POST", "/api/sync/lan/getIndex", lanGetIndex)
